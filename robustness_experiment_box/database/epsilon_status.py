...
class EpsilonStatus:
    ...
    meaning it records the epsilon value,
    the result (SAT, UNSAT, TIMEOUT, ERROR) and running time.
    """
    value: float
    ...
    def to_dict(self) -> dict:
        ...
        """
        return dict(epsilon_value=self.value,
                    result=self.result, time=self.time)
