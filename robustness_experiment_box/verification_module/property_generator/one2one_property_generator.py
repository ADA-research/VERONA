...
class One2OnePropertyGenerator(PropertyGenerator):
    """One2OnePropertyGenerator generates properties for targeted
    verification of neural networks.
    This means the property is violated if we can find a higher output value
    for the specificied class.
    """

    def __init__(self, target_class: int, number_classes: int = 10,
                 data_lb: int = 0, data_ub: int = 1):
        """
        Initialize the One2OnePropertyGenerator with the target class,
        number of classes, data lower bound, and data upper bound.
        Args:
            target_class (int): The target class for the property.
            number_classes (int): The number of classes in
    ...
    def create_vnnlib_property(self, image: np.array, image_class: int,
        ...
        """
        Create a VNNLib property for the given image, image class,
        and epsilon perturbation.
        Args:
    ...
    def from_dict(cls, data: dict):
        ...
        Args:
            ...
            One2OnePropertyGenerator attributes.
