...
class One2OnePropertyGenerator(PropertyGenerator):
    ...
    This means the property is violated if we can find a higher output value for the specificied class. 
    """
    ...
    def to_dict(self) -> dict:
        ...
        return dict(target_class=self.target_class, number_classes=self.number_classes, data_lb=self.data_lb, data_ub=self.data_ub, type = self.__class__.__name__, module = self.__class__.__module__, )
