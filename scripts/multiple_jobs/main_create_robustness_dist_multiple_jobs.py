...
def write_slurm_script(slurm_script_template: str, slurm_scripts_path: Path, file_verification_context: Path, base_path_experiment_repository: Path, \
    ...
    slurm_script_content = slurm_script_template.format(slurm_scripts_path=slurm_scripts_path, file_verification_context=file_verification_context, base_path_experiment_repository=base_path_experiment_repository, \
        network_folder=network_folder, experiment_name=experiment_name, epsilon_list=epsilon_list_str)
...
def create_distribution(experiment_repository: ExperimentRepository, dataset: ExperimentDataset, dataset_sampler: DatasetSampler, epsilon_list: np.ndarray):
    ...
    for network in network_list:
        ...
        for data_point in sampled_data: 
            ...
            write_slurm_script(slurm_script_template, slurm_scripts_path, file_verification_context, experiment_repository.base_path, experiment_repository.network_folder, experiment_path, epsilon_list, temp_slurm_script)
