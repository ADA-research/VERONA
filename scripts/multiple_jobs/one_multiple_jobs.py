...
if __name__ == "__main__":
    ...
    baby_experiment_repository.load_experiment(
    ...
    epsilon_value_estimator = BinarySearchEpsilonValueEstimator(
        epsilon_value_list=eps_list.copy(), verifier=verifier)

    # This is the same verification context as in the main file and its loaded
    # from the yaml file we created in the main file
    verification_context = (baby_experiment_repository.
                            load_verification_context_from_yaml(
                                Path(args.file_verification_context)))

    # get the epsilon value and save it in the reloaded repository
    # at the correct place
    epsilon_value_result = (epsilon_value_estimator
